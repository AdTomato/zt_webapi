...
public class OrgUserServiceImpl implements IOrgUserService {
    ...
    @Override
    public List<Map<String, String>> getAllOrgDeptUser() {
        return orgUserMapper.getAllOrgDeptUser();
    }

    @Override
    public void updateOrgUser(List<Map<String, String>> data) {
        orgUserMapper.updateOrgUser(data);
    }
}
