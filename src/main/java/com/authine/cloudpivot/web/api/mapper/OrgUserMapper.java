...
public interface OrgUserMapper {
    ...
    public OrgUser getUserInfo(String mobile);

    public OrgDepartment getDepartmentInfo(String parentId);

    List<Map<String, String>> getAllOrgDeptUser();

    void updateOrgUser(List<Map<String, String>> data);
}
