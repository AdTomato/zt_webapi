...
public class ExpertsAnnualAssServiceImpl implements ExpertsAnnualAssService {
    ...
    @Override
    public List<ExpertsInfo> findExportsList(ExpertsAssessInfo expertsAssessInfo) {
        return expertsAnnualAssMapper.findExportsList(expertsAssessInfo);
    }

    @Override
    public List<ExpertsInfo> findAllExportsList(ExpertsAssessInfo expertsAssessInfo) {
